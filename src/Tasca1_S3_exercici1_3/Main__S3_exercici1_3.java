...
public class Main__S3_exercici1_3 {
	...
	public static void main(String[] args) {
	    ...
	    String directoriActual = System.getProperty("user.dir"); // agafo el directori de treball actual 
	    String nomArxiu = "countries.txt";
		File fitxer = new File(File.separator + directoriActual + File.separator + nomArxiu); // ruta +  el directori actual
